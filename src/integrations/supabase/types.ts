    ...
    Tables: {
      ...
      wedding_details: {
        Row: {
          ...
          bride_full_name: string
          brides_parents_info: string | null
          ...
          groom_full_name: string
          grooms_parents_info: string | null
          id: number
          live_stream_link: string | null
          local_attractions: string | null
          love_story: string | null
          message_from_brides_parents: string | null
          message_from_grooms_parents: string | null
